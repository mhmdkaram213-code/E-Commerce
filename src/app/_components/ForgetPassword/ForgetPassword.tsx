'use client'
import { emailSchema } from "@/app/schema/emailSchema";
...
export default function ForgetPassword() {
  ...
  async function submitForm(values: zod.infer<typeof emailSchema>) {
    console.log(values);
    setIsLoading(true)
  ...
  return (
    <div className="w-full md:w-3/4 lg:w-1/2 mx-auto p-10 my-10 bg-gray-200 rounded-2xl shadow">
      <h2 className="text-2xl font-bold text-green-600 ">Forget Password</h2>
