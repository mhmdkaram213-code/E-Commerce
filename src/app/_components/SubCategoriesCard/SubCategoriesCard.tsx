...
export default function SubCategoryCard({ subCategory }: { subCategory: SubCategoryItem }) {
    return (
        <Card className="mb-12">
            <Link href={`/SubCategoryDetails/${subCategory._id}`}>
                <CardHeader className="flex flex-col items-center gap-4">
                    <CardTitle className="text-3xl text-center">{subCategory.name}</CardTitle>
                    <CardTitle className="text-2xl">{subCategory.category}</CardTitle>
            ...
            <CardFooter>
                <div className="flex items-center justify-center gap-4 w-full">
                    <Button>Visit SubCategory</Button>
                    <svg
